                            ...
                            <div class="panel-body p-20">
                                ...
                                <form action="result.php" method="post">
                                	<div class="form-group">
                                		<label for="refnum">Enter your Reference Number</label>
                                        <input type="text" class="form-control" id="refnum" placeholder="Enter your Reference Number" autocomplete="off" name="refnum">
                                	</div>
                               <div class="form-group">
