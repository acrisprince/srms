...
$dob=$_POST['dob']; 
$status=$_POST['status'];
$sql="update tblstudents set StudentName=:studentname,RefNum=:refnum,StudentEmail=:studentemail,Gender=:gender,DOB=:dob,Status=:status where StudentId=:stid ";
...
<div class="form-group">
<label for="default" class="col-sm-2 control-label">Ref Num</label>
<div class="col-sm-10">
<input type="text" name="refnum" class="form-control" id="refnum" value="<?php echo htmlentities($result->RefNum)?>" maxlength="5" required="required" autocomplete="off">
</div>
</div>
