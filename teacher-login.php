...
$sql ="SELECT TeacherRef,Password FROM tblteachers WHERE TeacherRef=:teacherref and Password=:password";
...
if($query->rowCount() > 0)
{
$_SESSION['tlogin']=$_POST['teacherref'];
                                                ...
                                                <div class="panel-body p-20">
                                                    ...
                                                    <form class="form-horizontal" method="post">
                                                    	<div class="form-group">
                                                    		<label for="inputEmail3" class="col-sm-2 control-label">Ref Num</label>
                                                    		<div class="col-sm-10">
                                                    			<input type="text" name="teacherref" class="form-control" id="inputEmail3" placeholder="UserName">
                                                    		</div>
                                                    	</div>
                                                    	<div class="form-group">
