<div class="left-sidebar bg-black-300 box-shadow ">
                        <div class="sidebar-content">
                            <div class="user-info closed">
                                <img src="../img/crisprince.jpg" alt="crisprince" class="img-circle profile-img">
...
<li class="has-children">
                                        <a href="#"><i class="fa fa fa-server"></i> <span>Users</span> <i class="fa fa-angle-right arrow"></i></a>
                                        <ul class="child-nav">
                                            <li><a href="add-users.php"><i class="fa fa-bars"></i> <span>Add Users</span></a></li>
                                            <li><a href="#"><i class="fa fa fa-server"></i> <span>Manage Users</span></a></li>
