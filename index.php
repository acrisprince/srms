            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                        ...
                        <li class="nav-item"><a class="nav-link active" href="find-result.php">Student</a></li>
                        <li class="nav-item"><a class="nav-link active" href="teacher-login.php">Teacher</a></li>
