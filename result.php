...
$qery = "SELECT   tblstudents.StudentName,tblstudents.RefNum,tblstudents.RegDate,tblstudents.StudentId,tblstudents.Status,tblclasses.ClassName,tblclasses.Section from tblstudents join tblclasses on tblclasses.id=tblstudents.ClassId where tblstudents.RefNum=:refnum and tblstudents.ClassId=:classid ";
...
<p><b>Student Ref Num :</b> <?php echo htmlentities($row->RefNum);?>
...
// Code for result
 ...
 $query ="select t.StudentName,t.RefNum,t.ClassId,t.marks,SubjectId,tblsubjects.SubjectName from (select sts.StudentName,sts.RefNum,sts.ClassId,tr.marks,SubjectId from tblstudents as sts join  tblresult as tr on tr.StudentId=sts.StudentId) as t join tblsubjects on tblsubjects.id=t.SubjectId where (t.RefNum=:refnum and t.ClassId=:classid)";
...
<?php
echo htmlentities("Invalid Reference Number");
 }
?>
                                        </div>
