...
CREATE TABLE `tblteachers` (
  `id` int(11) NOT NULL,
  `TeacherRef` varchar(100) DEFAULT NULL,
  `Password` varchar(100) DEFAULT NULL,
  `TeacherName` varchar(100) DEFAULT NULL,
  `TeacherNum` varchar(100) DEFAULT NULL,
  `TeacherEmail` varchar(100) DEFAULT NULL,
  `TeacherDOB` varchar(100) DEFAULT NULL,
  `TeacherClassId` int(11) DEFAULT NULL,
...
INSERT INTO `tblteachers` (`id`, `TeacherRef`, `Password`, `TeacherName`, `TeacherNum`, `TeacherEmail`, `TeacherDOB`, `TeacherClassId`, `Gender`, `RegDate`, `updationDate`, `Status`) VALUES
(1, 'UA11', '827ccb0eea8a706c4c34a16891f84e7b', 'Afia Mansah', NULL, 'Afia@admin.com', '2002-10-10', 1, 'Female',  '2022-01-01 10:30:57', '2022-01-01 10:30:57', 1);
...
INSERT INTO `tblstudents` (`StudentId`, `StudentName`, `RefNum`, `StudentEmail`, `Gender`, `DOB`, `ClassId`, `RegDate`, `UpdationDate`, `Status`) VALUES
